...
namespace TelerikXamarinForms.Droid
{
    [Activity(Label = "TelerikXamarinForms", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
